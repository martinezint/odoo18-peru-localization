...
class TestSunatSireRestClient(TransactionCase):
    ...
    def test_invalid_env_raises(self):
        with self.assertRaisesRegex(ValueError, "environment"):
            SunatSireRestClient(client_id="x", client_secret="y", ruc="r", environment="staging")

    def test_missing_creds_raise_auth_error(self):
        with self.assertRaises(SireAuthError):
            SunatSireRestClient(client_id="", client_secret="y", ruc="r", environment="beta")
    ...
    def test_get_token_success(self):
        ...
        self.assertEqual(call_kwargs["data"]["scope"], "https://api-sire.sunat.gob.pe")
    ...
    def test_request_rce_error_status(self):
        ...
        with patch(
            "httpx.request",
            return_value=_mk_response(400, {"cod": "9001", "msg": "Período no abierto"}),
        ):
    ...
    def test_request_rvie_returns_ticket(self):
        ...
        with patch(
            "httpx.request", return_value=_mk_response(200, {"numTicket": "V-99"})
        ) as mock_req:
    ...
    def test_401_refreshes_token_and_retries(self):
        ...
        with (
            patch("httpx.request", side_effect=[first_401, ok_resp]),
